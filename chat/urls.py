...
urlpatterns = [
    ...
    path('api/chats/<str:chat_id>/delete/', views.delete_chat, name='delete_chat'),
    ...
    path('api/documents/<int:document_id>/summarize/', views.summarize_document, name='summarize_document'),
    path('api/documents/<int:document_id>/ask/', views.ask_document, name='ask_document'),
